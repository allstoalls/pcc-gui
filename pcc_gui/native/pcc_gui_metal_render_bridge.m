// Canonical pcc-gui Metal/AppKit bridge. Maintained in this repository.
// Extracted from allstoalls/pcc@77cdf411, pcc/kernel_ir/metal_render_surface.py.
...
void *pcc_gui_metal_window_create(const char *title, int64_t width, int64_t height) {
  @autoreleasepool {
    ...
    /* The exported handle owns this retain; close must not autorelease it. */
